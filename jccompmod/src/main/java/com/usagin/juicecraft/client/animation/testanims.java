...
public class testanims {
    public static final AnimationDefinition testanim = AnimationDefinition.Builder.withLength(3.5F).looping()
            .addAnimation("hip", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, 38.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
            ))
            .addAnimation("rightarm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(1.5F, KeyframeAnimations.degreeVec(-63.3913F, 84.4113F, 26.4996F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.0F, KeyframeAnimations.degreeVec(-63.3913F, 84.4113F, 26.4996F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(3.0F, KeyframeAnimations.degreeVec(-63.3913F, 84.4113F, 26.4996F), AnimationChannel.Interpolations.LINEAR),
